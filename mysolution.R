...
## We will need to cleen up those missing values in a way that will help us then create a reliable model
...
## Fare has a minimal deviance of 0.085 and doesn't improve our model, so we remove it
...
>>>>>>> a7a8c682682705d48c9ed2e631e5a01acda52208
